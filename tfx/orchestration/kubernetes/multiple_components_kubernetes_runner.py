...
from tfx.orchestration.launcher import looped_kubernetes_component_launcher
...
_DRIVER_COMMAND = [
    'python', '/TFX/project/tfx/tfx/orchestration/kubernetes/driver_container_entrypoint.py'
]
  ...
  def __init__(self,
    ...
    Args:
      config: Optional pipeline config for customizing the launching of each
        ...
        LoopedKubernetesLauncher and KubernetesComponentLauncher.
    """
    if config is None:
      config = pipeline_config.PipelineConfig(
          supported_launcher_classes=[
              looped_kubernetes_component_launcher.LoopedKubernetesLauncher,
